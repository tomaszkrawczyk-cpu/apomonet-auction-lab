...
export function adjudicateRecognition(raw, candidates, inputMeasurements = {}) {
  ...
  if (!selected) {
    const compatible = rankEvidenceCandidates(observations, candidates, measurements).ranked
    ...
    return {
      ...
      followUpQuestions: compatible.length
      ...
      measurements,
      candidates: publicCandidates(compatible, null),
    };
  }
