...
/**
 * A museum record may correct OCR only after the visual gate establishes that
 * the submitted photo is the same physical specimen. A same-type result is
 * deliberately insufficient because neighboring years can share a design.
 */
...
export const visualRecognitionPolicy = Object.freeze({
  version: "stage1-visual-reranker-v6",
