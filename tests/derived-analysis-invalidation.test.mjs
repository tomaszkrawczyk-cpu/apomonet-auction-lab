...
test('accepted identity correction invalidates stale Stage 2 catalog literature and valuation data',()=>{
  ...
  const coin={id:'coin-1',...rawAI,nominal:'dukat',mint:'Nagybánya',userAccepted:true,rawAI,obverseImage:'obverse-photo',reverseImage:'reverse-photo',detail:{variant:'stary wariant',kopickiReference:'1234',fullDescription:'Stary opis szczegółowy'},kopickiReference:'1234',kopickiRarity:'R3',catalogEvidenceStatus:'supported-by-stage2-variant-evidence',catalogVerification:'verified-curated',catalogCandidate:{reference:'K. 1234',rarity:'R3'},catalogCandidateReference:'K. 1234',catalogCandidateRarity:'R3',kopickiCandidate:'K. 1234',tyszkiewiczReference:'T. 12',tyszkiewiczValue:'8',parchimowiczReference:'P. 99',specialistReferences:[{id:'other'}],literatureEvidence:{source:'old-match'},auctionRecords10y:12,marketMedian:4200,estimateLow:3500,estimateHigh:5000,analysisLevel:'detailed'};
  ...
  for(const key of ['detail','kopickiReference','kopickiRarity','catalogEvidenceStatus','catalogVerification','catalogCandidate','catalogCandidateReference','catalogCandidateRarity','kopickiCandidate','tyszkiewiczReference','tyszkiewiczValue','parchimowiczReference','specialistReferences','literatureEvidence','auctionRecords10y','marketMedian','estimateLow','estimateHigh'])assert.equal(result[key],undefined,key);
