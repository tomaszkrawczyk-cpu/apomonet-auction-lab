...
const ApoI18n=(()=>{
  ...
  const T={
    ...
    'Filtry':{en:'Filters',de:'Filter',fr:'Filtres'},'Sortuj':{en:'Sort',de:'Sortieren',fr:'Trier'},
    'Kafelki':{en:'Tiles',de:'Kacheln',fr:'Vignettes'},'Zaznacz':{en:'Select',de:'Auswählen',fr:'Sélectionner'},
    'Gotowe':{en:'Done',de:'Fertig',fr:'Terminé'},'Sortowanie monet':{en:'Sort coins',de:'Münzen sortieren',fr:'Trier les monnaies'},
    'Ostatnio dodane':{en:'Recently added',de:'Zuletzt hinzugefügt',fr:'Ajoutées récemment'},
    'Rok — najstarsze najpierw':{en:'Year — oldest first',de:'Jahr — älteste zuerst',fr:'Année — plus anciennes d’abord'},
    'Rok — najnowsze najpierw':{en:'Year — newest first',de:'Jahr — neueste zuerst',fr:'Année — plus récentes d’abord'},
    'Nominał — największe najpierw':{en:'Denomination — largest first',de:'Nominal — größte zuerst',fr:'Valeur — plus grandes d’abord'},
    'Nominał — najmniejsze najpierw':{en:'Denomination — smallest first',de:'Nominal — kleinste zuerst',fr:'Valeur — plus petites d’abord'},
    'Pokaż kolejne 60':{en:'Show next 60',de:'Weitere 60 anzeigen',fr:'Afficher les 60 suivantes'},
    'Miniatury, szybkie wyszukiwanie i dwa czytelne widoki kolekcji.':{en:'Thumbnails, quick search and two clear collection views.',de:'Miniaturen, Schnellsuche und zwei übersichtliche Sammlungsansichten.',fr:'Miniatures, recherche rapide et deux vues claires de la collection.'},
    'Szukaj: władca, nominał, rok, mennica…':{en:'Search: ruler, denomination, year, mint…',de:'Suchen: Herrscher, Nominal, Jahr, Münzstätte…',fr:'Rechercher : souverain, valeur, année, atelier…'},
    'Sposób wyświetlania kolekcji':{en:'Collection display mode',de:'Darstellung der Sammlung',fr:'Mode d’affichage de la collection'},
    'Wybierz jeden prosty sposób ułożenia kolekcji.':{en:'Choose one simple way to arrange the collection.',de:'Wählen Sie eine einfache Sortierung der Sammlung.',fr:'Choisissez une méthode simple pour classer la collection.'},
    'Anuluj':{en:'Cancel',de:'Abbrechen',fr:'Annuler'},'Excel z wybranych':{en:'Excel from selected',de:'Excel aus Auswahl',fr:'Excel de la sélection'},
    'Brak zapisanego zdjęcia':{en:'No saved photo',de:'Kein gespeichertes Foto',fr:'Aucune photo enregistrée'},
    'Kolekcja jest pusta albo filtry ukrywają wszystkie monety.':{en:'The collection is empty or the filters hide all coins.',de:'Die Sammlung ist leer oder die Filter blenden alle Münzen aus.',fr:'La collection est vide ou les filtres masquent toutes les monnaies.'},
    'Rok nieustalony':{en:'Year unknown',de:'Jahr unbekannt',fr:'Année inconnue'},'Moneta bez nazwy':{en:'Unnamed coin',de:'Unbenannte Münze',fr:'Monnaie sans nom'},
    'Dane do uzupełnienia':{en:'Data to complete',de:'Daten ergänzen',fr:'Données à compléter'},'Szacunkowo':{en:'Estimated',de:'Geschätzt',fr:'Estimation'},
