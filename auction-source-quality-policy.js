(()=>{
  ...
  ApoArchive.valuation=(coin,years=10,currency='PLN')=>{
    ...
    // A record may look numerically "usable" while still missing a direct source URL or another core fact.
    // Such records remain visible as market facts but cannot drive valuation.
