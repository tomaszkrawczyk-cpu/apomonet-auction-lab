(() => {
  ...
  const COPY = {
    pl: {
      ...
      typeKnown: "Typ ustalony — odmiana wymaga analizy szczegółowej.",
      ...
      varietyKnown: "Odmiana potwierdzona",
    ...
    en: {
      ...
      varietyKnown: "Variety confirmed",
    ...
    de: {
      ...
      varietyKnown: "Variante bestätigt",
    ...
    fr: {
      ...
      varietyKnown: "Variété confirmée",
